...
def generate_prompt(api_key: str, api_url: str, raw_input: str,
                   ...
                   prompt_mode: str = "text", # NEW: Added prompt_mode
                   category: str = None,      # NEW: Added category
                   subcategory: str = None,   # NEW: Added subcategory
                   persona: str = None,       # NEW: Added persona
                   timeout: int = 10):
   """
   ...
   payload = {
       ...
       "prompt_mode": prompt_mode # Include prompt_mode in payload
   }
...
def reverse_prompt(api_key: str, api_url: str, input_text: str,
                  language_code: str = "en-US",
                  prompt_mode: str = "text", # NEW: Added prompt_mode for consistency, though only 'text' is currently applicable
                  timeout: int = 10):
   """
